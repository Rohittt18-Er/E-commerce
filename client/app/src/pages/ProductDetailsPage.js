...
import AddedToCartMessageComponent from "../components/cartItem/AddToCartMessageComponent";
          ...
          <Row>
            <Col md={8}>
              <ListGroup variant="flush">
                ...
                <ListGroup.Item>
                  <Rating readonly size={5} initialValue={4} /> (1)
                </ListGroup.Item>
                <ListGroup.Item>
            ...
            <Col md={4}>
              <ListGroup>
                ...
                <ListGroup.Item>
                  <Button onClick={()=>{
                    alert("lhf")
                  }} className="mb-3 mt-3" variant="danger">Add to cart</Button>
                </ListGroup.Item>
              </ListGroup>
            </Col>
          </Row>
